                    ...
                    <div class="row mt-5">
                        ...
                        <div class="col-xl-8">
                            <div id="faqs-accordion" class="custom-accordion mt-5 mt-xl-0">
                                ...
                                <div class="card border shadow-none">
                                    <a href="#faqs-pricing-plans-collapse" class="text-dark collapsed" data-toggle="collapse" aria-expanded="false" aria-controls="faqs-pricing-plans-collapse">
                                        <div class="bg-light p-3">
                                    ...
                                    <div id="faqs-pricing-plans-collapse" class="collapse" data-parent="#faqs-accordion">
                                        <div class="p-4">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div>
