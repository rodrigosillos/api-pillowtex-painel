        ...
        <div class="col-12">
            ...
            <div class="email-leftbar card">
                ...
                <div class="mail-list mt-4">
                    <a href="#" class="active"><i class="mdi mdi-email-outline font-size-16 align-middle mr-2"></i> Inbox <span class="ml-1 float-right">(18)</span></a>
            ...
            <div class="email-rightbar mb-3">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{url('email-compose')}}" class="btn btn-secondary waves-effect mt-4"><i class="mdi mdi-reply"></i> Reply</a>
                    </div>
