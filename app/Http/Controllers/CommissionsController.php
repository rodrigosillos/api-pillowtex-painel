    ...
    public function getInvoices(Request $request)
    {
        ...
        foreach($invoices as $invoiceKey => $invoice) {
            ...
            foreach($invoiceProducts as $invoiceProductKey => $invoiceProduct) {
                ...
                // product data add
                $commissionResult[$invoiceKey]['produtos'][$invoiceProductKey]['pedido'] = $orderId;
                $commissionResult[$invoiceKey]['produtos'][$invoiceProductKey]['nota'] = $productInvoice;
                $commissionResult[$invoiceKey]['produtos'][$invoiceProductKey]['produto'] = $productId;
                $commissionResult[$invoiceKey]['produtos'][$invoiceProductKey]['produto_nome'] = $productName;
                $commissionResult[$invoiceKey]['produtos'][$invoiceProductKey]['quantidade'] = $productQty;
                $commissionResult[$invoiceKey]['produtos'][$invoiceProductKey]['preco'] = $productPrice;
                $commissionResult[$invoiceKey]['produtos'][$invoiceProductKey]['desconto'] = $productDiscount;
