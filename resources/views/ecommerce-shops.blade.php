                    ...
                    <div class="media">
                        ...
                        <div class="media-body align-self-center">
                            <div class="border-bottom pb-1">
                                ...
                                <p class="text-muted">
                                    <i class="mdi mdi-account mr-1"></i> Clifton Taylor
                                </p>
                            </div>
                            <div class="row">
                                <div class="col-6">
                    ...
                    <div class="media">
                        ...
                        <div class="media-body align-self-center">
                            <div class="border-bottom pb-1">
                                ...
                                <p class="text-muted">
                                    <i class="mdi mdi-account mr-1"></i> Karl Early
                                </p>
                            </div>
                            <div class="row">
                                <div class="col-6">
                    ...
                    <div class="media">
                        ...
                        <div class="media-body align-self-center">
                            <div class="border-bottom pb-1">
                                ...
                                <p class="text-muted">
                                    <i class="mdi mdi-account mr-1"></i> Marion Glaze
                                </p>
                            </div>
                            <div class="row">
                                <div class="col-6">
                    ...
                    <div class="media">
                        ...
                        <div class="media-body align-self-center">
                            <div class="border-bottom pb-1">
                                ...
                                <p class="text-muted">
                                    <i class="mdi mdi-account mr-1"></i> Brent Johnson
                                </p>
                            </div>
                            <div class="row">
                                <div class="col-6">
                    ...
                    <div class="media">
                        ...
                        <div class="media-body align-self-center">
                            <div class="border-bottom pb-1">
                                ...
                                <p class="text-muted">
                                    <i class="mdi mdi-account mr-1"></i> Kimberly Martinez
                                </p>
                            </div>
                            <div class="row">
                                <div class="col-6">
                    ...
                    <div class="media">
                        ...
                        <div class="media-body align-self-center">
                            <div class="border-bottom pb-1">
                                ...
                                <p class="text-muted">
                                    <i class="mdi mdi-account mr-1"></i> Sarah Stewart
                                </p>
                            </div>
                            <div class="row">
                                <div class="col-6">
                    ...
                    <div class="media">
                        ...
                        <div class="media-body align-self-center">
                            <div class="border-bottom pb-1">
                                <h5 class="text-truncate font-size-16 mb-1"><a href="#" class="text-dark">Tech Hifi</a></h5>
                                <p class="text-muted">
                                    <i class="mdi mdi-account mr-1"></i> Lauren Doyle
                                </p>
                            </div>
                            <div class="row">
                                <div class="col-6">
                    ...
                    <div class="media">
                        ...
                        <div class="media-body align-self-center">
                            <div class="border-bottom pb-1">
                                <h5 class="text-truncate font-size-16 mb-1"><a href="#" class="text-dark">Brendle's</a></h5>
                                <p class="text-muted">
                                    <i class="mdi mdi-account mr-1"></i> Elaina Torres
                                </p>
                            </div>
                            <div class="row">
                                <div class="col-6">
                    ...
                    <div class="media">
                        ...
                        <div class="media-body align-self-center">
                            <div class="border-bottom pb-1">
                                ...
                                <p class="text-muted">
                                    <i class="mdi mdi-account mr-1"></i> Willie Farber
                                </p>
                            </div>
                            <div class="row">
                                <div class="col-6">
