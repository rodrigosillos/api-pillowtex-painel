...
class SubstituicaoController extends Controller
{
    ...
    {           
        ...
        return view('substituicao-filtro', $collection);
    }
    ...
    { 
        ...
        representante = ".$representanteId." and tipo_pagto not in (select tipo_pgto from tipos_pgto where oculto = 1) and substituido = 1 and protesto = 0 and gerador = 'C' and baixa = 0 and data_pagamento between '". $dateStart ."' and '". $dateEnd ."' or
        representante_movimento = '".$representanteSelecionado."' and tipo_pagto not in (select tipo_pgto from tipos_pgto where oculto = 1) and substituido = 1 and protesto = 0 and gerador = 'C' and baixa = 0 and data_pagamento between '". $dateStart ."' and '". $dateEnd ."' or
        representante_cliente = '".$representanteSelecionado."' and tipo_pagto not in (select tipo_pgto from tipos_pgto where oculto = 1) and substituido = 1 and protesto = 0 and gerador = 'C' and baixa = 0 and data_pagamento between '". $dateStart ."' and '". $dateEnd ."' or 
        representante_pedido = '".$representanteSelecionado."' and tipo_pagto not in (select tipo_pgto from tipos_pgto where oculto = 1) and substituido = 1 and protesto = 0 and gerador = 'C' and baixa = 0 and data_pagamento between '". $dateStart ."' and '". $dateEnd ."';";
        ...
        return view('substituicao-filtro', 
        [
