            ...
            <div class="card">
                <div class="card-body">
                    <div class="invoice-title">
                        <h4 class="float-right font-size-16">Invoice #MN0131 <span class="badge badge-success font-size-12 ml-2">Paid</span></h4>
                        <div class="mb-4">
                            <img src="{{ URL::asset('assets/images/logo-dark.png')}}" alt="logo" height="20"/>
                        </div>
                        <div class="text-muted">
                            <p class="mb-1">641 Counts Lane Wilmore, KY 40390</p>
                            <p class="mb-1"><i class="uil uil-envelope-alt mr-1"></i> abc@123.com</p>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <ul class="list-inline mb-0">
                                                <li class="list-inline-item">Color : <span class="font-weight-medium">Gray</span></li>
                                                <li class="list-inline-item">Size : <span class="font-weight-medium">08</span></li>
                                            </ul>
                                        </td>
                                        <td>$260</td>
                                        <td>1</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <ul class="list-inline mb-0">
                                                <li class="list-inline-item">Color : <span class="font-weight-medium">Black</span></li>
                                                <li class="list-inline-item">Size : <span class="font-weight-medium">09</span></li>
                                            </ul>
                                        </td>
                                        <td>$250</td>
                                        <td>1</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="border-0 text-right"><h4 class="m-0">$498.00</h4></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
