...
$sql = "select cod_operacao, tipo_operacao, cliente_estado, tabela, comissao_r, evento, tipo_pedido from movimentacao where tipo_operacao = 'S' and data_emissao between '2023-07-01' and '2023-07-14'";
