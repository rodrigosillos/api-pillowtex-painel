                        ...
                        <div data-repeater-list="group-a">
                            ...
                            <div data-repeater-item class="row">
                                ...
                                <div class="form-group col-lg-2">
                                    ...
                                    <input type="text" id="tabela_{{ $key }}" name="tabela" class="form-control" value="{{ $value['tabela'] }}"/>
                                </div>

                                <div class="form-group col-lg-2">
                                    <label for="cod_divisao_{{ $key }}">Cod Divisão</label>
                                    <input type="text" id="cod_divisao_{{ $key }}" name="cod_divisao" class="form-control" value="{{ $value['cod_divisao'] }}"/>
                                </div>

                                <div class="form-group col-lg-2">
                                    <label for="descricao_divisao_{{ $key }}">Descrição Divisão</label>
                                    <input type="text" id="descricao_divisao_{{ $key }}" name="descricao_divisao" class="form-control" value="{{ $value['descricao_divisao'] }}"/>
                                </div>
