                    ...
                    <div class="card pricing-box text-center">
                        <div class="card-body p-4">
                            ...
                            <ul class="list-unstyled plan-features mt-3">
                                <li>Users: <span class="text-primary font-weight-semibold">1</span></li>
                                <li>Storage: <span class="text-primary font-weight-semibold">01 GB</span></li>
                                <li>Domain: <span class="text-primary font-weight-semibold">No</span></li>
                                <li>Support: <span class="text-primary font-weight-semibold">No</span></li>
                                <li>Setup: <span class="text-primary font-weight-semibold">No</span></li>
                            </ul>
                ...
                <div class="col-xl-4">
                    <div class="card pricing-box text-center">
                        <div class="card-body p-4">
                            ...
                            <ul class="list-unstyled plan-features mt-3">
                                <li>Users: <span class="text-primary font-weight-semibold">3</span></li>
                                <li>Storage: <span class="text-primary font-weight-semibold">10 GB</span></li>
                                <li>Domain: <span class="text-primary font-weight-semibold">1</span></li>
                                <li>Support: <span class="text-primary font-weight-semibold">Yes</span></li>
                                <li>Setup: <span class="text-primary font-weight-semibold">No</span></li>
                            </ul>
                ...
                <div class="col-xl-4">
                    <div class="card pricing-box text-center">
                        <div class="card-body p-4">
                            ...
                            <ul class="list-unstyled plan-features mt-3">
                                <li>Users: <span class="text-primary font-weight-semibold">5</span></li>
                                <li>Storage: <span class="text-primary font-weight-semibold">40 GB</span></li>
                                <li>Domain: <span class="text-primary font-weight-semibold">4</span></li>
                                <li>Support: <span class="text-primary font-weight-semibold">Yes</span></li>
                                <li>Setup: <span class="text-primary font-weight-semibold">Yes</span></li>
                            </ul>
